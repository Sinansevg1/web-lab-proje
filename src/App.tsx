    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <div className="fixed top-4 left-4 z-50 flex gap-2">
        <button
          ...
          className="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-4 py-2 rounded-full shadow-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-all font-medium"
        >
          {showUIKit ? 'Portfolyo Gör' : 'UI Kit Gör'}
        </button>
      </div>
